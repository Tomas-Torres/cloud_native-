package com.lumina.pagos.exception;
...
class GlobalExceptionHandlerTest {
    ...
    void handleValidationException_DebeRetornar400ConErroresDeCampo() {
        ...
        FieldError fieldError1 = new FieldError("request", "ordenId", "El ID de orden es obligatorio");
        FieldError fieldError2 = new FieldError("request", "usuarioId", "El ID de usuario es obligatorio");
        ...
        assertThat(errors.get("ordenId")).isEqualTo("El ID de orden es obligatorio");
        assertThat(errors.get("usuarioId")).isEqualTo("El ID de usuario es obligatorio");
    }
